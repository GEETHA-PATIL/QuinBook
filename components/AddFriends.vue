    ...
    <div class="Body">
        ...
        <div class="middle">
            <div :style="{
                ...
                <br /><br />
                <div class="list" v-for="user in getUsers" :key="user">
...
export default {
    ...
    methods: {
        ...
        toggle(sender, email) {
            ...
            this.axios.post(`http://localhost:8082/request/addFriendRequest/${this.userid}/${sender}`)
                .then((result) => {
                ...
                this.axios.get(`http://localhost:8082/user/userName/${this.userid}`, {
                })
                .then((resp) => {
                    this.userName = resp.data;
                    console.log('hiiii', resp.data)
                }),

                this.axios.post(`http://10.20.2.201:8995/friendRequest`, {
                    app: "QUINBOOK",
                    ...
                    console.log(resp.data, this.userName, email)
                })
