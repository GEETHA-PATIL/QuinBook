...
<div class="main">
    ...
    <div class="Body">
        <!-- <div class="left">
            ...
            <div class="elementstyling">
                <img src="@/assets/page.png" alt="pages">
                Pages
            </div>
            <div class="elementstyling">
        ...
        <div class="middle">
            <div :style="{
                ...
                <br /><br />
                  <div class="list" v-for="user in getrequest" :key="user"  >
                    
                    <ul class="list">
                        <li class="list-item">
                            <div>
                                <img :src="user.receiverImage" alt="" class="list-item-image" />
                            </div>
                            ...
                            <div class="add-btn" @click="toggle(user.id)">
                                <div class="plus">
...
export default {
    ...
    methods: {
      ...mapActions(['handleUsers']),
        handlerequest() {
           this.axios.get(`http://localhost:8082/request/getAllFriends/${this.userid}`).then(resp => {
      ...
      toggle(user){
            console.log(user)
            this.axios.delete(`http://localhost:8082/request/delete/${user}`).then(resp=>{
                console.log(resp)
                this.$router.go()
            })
      },
    //   getUserName(user){
    //         Vue.axios.get(`http://localhost:8082/userName/${user}`)
    //         .then((resp)=>{
...
//         },
        ...
        // new(){
        //    this.newarray=this.getUsers.filter(post=>post.userId===this.userid
