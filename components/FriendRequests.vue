            ...
            <div :style="{
                ...
                <div class="list" v-for="user in getrequest" :key="user">
                    ...
                    <ul class="list">
                        <li class="list-item">
                            <div>
                                <img :src="user.senderImage" alt="" class="list-item-image" />
                            </div>
                            ...
                            <div class="add-btn" @click="toggle(user.id)">
                                ...
                                <div class="text">
                                    <div class="button">Accept Request</div>
                                </div>
                            </div>
                        </li>
                    </ul>
...
export default {
    ...
    methods: {
        ...
        handlerequest() {
            ...
            this.axios.get(`http://localhost:8082/request/getFriendRequest/${this.userid}`).then(resp => {
        ...
        toggle(requestid) {
            ...
            this.axios.put(`http://localhost:8082/request/updateStatus/${requestid}`).then(resp => {
                console.log(resp)
                this.$router.go()
            })
